    ...
    <footer class="w-full bg-gray-50">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-8 py-10 max-w-xs mx-auto sm:max-w-2xl lg:max-w-full">
                <div class="col-span-full lg:mb-10 max-lg:border-b max-lg:pb-8 lg:border-r border-gray-200 lg:col-span-2 lg:max-w-xs lg:mb-0">
                    <a href="https://pagedone.io/"  class="flex justify-center mb-12 lg:justify-start">
                        <img src="/img/small.png" class="">
                    </a>
                    <ul class="grid gap-5">
                        ...
                        <li class="flex items-center justify-center gap-2 lg:justify-start">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                Tel: 8-817.3031 - 34 & 45
                        </li>
                        <li class="flex items-center justify-center gap-2 lg:justify-start text-center">
                            <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M9.66536 7.7406C9.66536 8.69945 8.91917 9.47676 7.9987 9.47676C7.07822 9.47676 6.33203 8.69945 6.33203 7.7406C6.33203 6.78175 7.07822 6.00445 7.9987 6.00445C8.91917 6.00445 9.66536 6.78175 9.66536 7.7406Z" stroke="#4F46E5" stroke-width="1.6"/>
                                    ...
                                    88 Corporate Center Building Sedeno 
                                    COR. Valero Sts.,Salcedo Village, Makati City
                        </li>
                    </ul>
                </div>
                <!--End Col-->
                ...
                <div class="lg:mx-auto text-left">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">Motorcar</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Fire</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Bonds</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Marine Lines </a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Engineering Lines </a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Casualty Lines</a></li>
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center ">
                    <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">Intrastrata Assurance Corporation</a> 2025, All rights reserved.</span>
                </div>
            </div>
        </div>
    </footer>
