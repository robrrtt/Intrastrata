...
// Define props directly (no need for `props` variable)
defineProps({
  icon: [String, Array], // Accept both string and array
  title: String,
  text: String,
});
</script>
...
<template>
  <div class="w-full md:w-56 p-6 bg-white border border-gray-200 rounded-lg shadow-md transition hover:shadow-lg">
    ...
    <h5 class="mb-2 text-lg font-semibold text-gray-900 text-center">
      {{ title }}
    </h5>
